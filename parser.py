                    ...
                    if isinstance(x,str) and (isinstance(y,int) or isinstance(y,float)):
                        if isinstance(y,int) and x.isdigit():
                            ...
                            try:
                                ...
                                print("ERROR:Cannot be converted to NUMBR or NUMBAR")
                                exit()
                    ...
                    if temp1[0][1]=="R":
                        ...
                        if re.search(r"STRING",temp1[0][0]):
                            ...
                            if temp1[1][1]!=varname[1]:
                                print("SYNTAX ERROR: <var> R MAEK A <var> <datatype> should refer to the same variable")
                                exit()
                            ...
                            if temp1[2][1]=="TROOF":
                                ...
                                if isinstance(symbol_table[temp1[1][1]],int):
                                    ...
                                    try:
                                        ...
                                        print("ERROR: CANNOT BE TYPECASTED INTO NUMBAR")
                                        exit()
